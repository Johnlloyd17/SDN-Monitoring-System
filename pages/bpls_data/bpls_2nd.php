        ...
        <aside class="right-side">
            <section class="content-header">
                <div class="header-title">
                    <img src="icons/second_district1.png" alt="Logo" class="header-logo" />
                    <div class="header-info">
                        <h3 style="color: darkwhite; font-weight: bold;">2nd District Count</h3>
                        <p class="header-address">Overview of Local Government Units in District 2</p>
                    </div>
                                        ...
                                        <form method="post">
                                            <table id="table" class="table table-bordered table-striped">
                                                ...
                                                <?php
                                                 ...
                                                 $tableQuery = "SELECT * FROM tblbpls WHERE district = '2nd District'";
