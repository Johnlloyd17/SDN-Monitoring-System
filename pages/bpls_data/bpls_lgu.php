        ...
        <aside class="right-side">
            <section class="content-header">
                <div class="header-title">
                    <img src="icons/municipality1.png" alt="Logo" class="header-logo" />
                    <div class="header-info">
                        <h3 style="color: darkwhite; font-weight: bold;">Total No. LGU</h3>
                        <p class="header-address">Count of Local Government Units</p>
                    </div>
                                                ...
                                                <div class="col-md-3 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="businessynSelect" name="businessyn" class="form-control" onchange="this.form.submit()">
                                                            ...
                                                            $agenciesQuery = mysqli_query($con, "SELECT DISTINCT businessyn FROM tblbpls WHERE businessyn != ''");
                                                ...
                                                <div class="col-md-3 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="barangayynSelect" name="barangayyn" class="form-control" onchange="this.form.submit()">
                                                            ...
                                                            <?php
                                                            // Fetching distinct requesting agencies
                                                            $agenciesQuery = mysqli_query($con, "SELECT DISTINCT barangayyn FROM tblbpls WHERE barangayyn != ''");
                                                ...
                                                <div class="col-md-3 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="buildingynSelect" name="buildingyn" class="form-control" onchange="this.form.submit()">
                                                            ...
                                                            <?php
                                                            // Fetching distinct requesting agencies
                                                            $agenciesQuery = mysqli_query($con, "SELECT DISTINCT buildingyn FROM tblbpls WHERE buildingyn != ''");
                                                ...
                                                <div class="col-md-3 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="workingynSelect" name="workingyn" class="form-control" onchange="this.form.submit()">
                                                            ...
                                                            <?php
                                                            // Fetching distinct requesting agencies
                                                            $agenciesQuery = mysqli_query($con, "SELECT DISTINCT workingyn FROM tblbpls WHERE workingyn != ''");
                                                ...
                                                <div class="col-md-3 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="bplynSelect" name="bplyn" class="form-control" onchange="this.form.submit()">
                                                            ...
                                                            <?php
                                                            // Fetching distinct requesting agencies
                                                            $agenciesQuery = mysqli_query($con, "SELECT DISTINCT bplyn FROM tblbpls WHERE bplyn != ''");
                                                ...
                                                <div class="col-md-3 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="ecedulaynSelect" name="ecedulayn" class="form-control" onchange="this.form.submit()">
                                                            ...
                                                            <?php
                                                            // Fetching distinct requesting agencies
                                                            $agenciesQuery = mysqli_query($con, "SELECT DISTINCT ecedulayn FROM tblbpls WHERE ecedulayn != ''");
                                                ...
                                                <div class="col-md-3 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="elcrynSelect" name="elcryn" class="form-control" onchange="this.form.submit()">
                                                            ...
                                                            <?php
                                                            // Fetching distinct requesting agencies
                                                            $agenciesQuery = mysqli_query($con, "SELECT DISTINCT elcryn FROM tblbpls WHERE elcryn != ''");
