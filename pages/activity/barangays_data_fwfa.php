                                            ...
                                            <div class="col-md-3 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="barangaySelect" name="barangay" class="form-control" onchange="this.form.submit()">
                                                            ...
                                                            $barangayQuery = "SELECT DISTINCT barangay FROM tblactivity WHERE barangay != '' AND project = 'FWFA'";
                                                ...
                                                <div class="col-md-3 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="yearSelect" name="year" class="form-control" onchange="this.form.submit()">
                                                            ...
                                                            $yearQuery = "SELECT DISTINCT YEAR(start) AS year FROM tblactivity WHERE barangay != '' AND project = 'FWFA' AND start != ''";
                                                ...
                                                <div class="col-md-3 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="monthSelect" name="month" class=" form-control" onchange="this.form.submit()">
                                                            ...
                                                            $monthQuery = "SELECT DISTINCT MONTH(start) AS month FROM tblactivity WHERE barangay != '' AND project = 'FWFA'";
                                                            if (isset($_POST['barangay']) && $_POST['barangay'] != '') {
                                                                $barangay = mysqli_real_escape_string($con, $_POST['barangay']);
                                    ...
                                    <form method="post">
                                        <table id="table" class="table table-bordered table-striped">
                                            ...
                                            <?php
                                             ...
                                             $tableQuery = "SELECT * FROM tblactivity WHERE barangay != '' and project = 'FWFA'";
