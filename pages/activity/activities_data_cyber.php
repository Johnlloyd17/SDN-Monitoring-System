        ...
        <aside class="right-side">
            <section class="content-header">
                <div class="header-title">
                    <img src="img/icons/activity.png" alt="Logo" class="header-logo" />
                    <div class="header-info">
                        <h3 style="color: darkwhite; font-weight: bold;">Total Activities</h3>
                        <p class="header-address">Total Count of Activities Conducted</p>
                    </div>
                                            ...
                                            <div class="col-md-3 col-sm-6 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <select id="modeSelect" name="mode" class="form-control" onchange="this.form.submit()">
                                                        ...
                                                        <?php
                                                        // Fetch modes
                                                        $modeQuery = "SELECT DISTINCT mode FROM tblactivity WHERE project = 'Cybersecurity' AND mode IS NOT NULL AND mode != ''";
                                            ...
                                            <div class="col-md-3 col-sm-6 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <select id="yearSelect" name="year" class="form-control" onchange="this.form.submit()">
                                                        ...
                                                        $yearQuery = "SELECT DISTINCT YEAR(start) AS year FROM tblactivity WHERE project = 'Cybersecurity'";
                                                        if (isset($_POST['project']) && $_POST['project'] != '') {
                                                            $sector = mysqli_real_escape_string($con, $_POST['project']);
                                            ...
                                            <div class="col-md-3 col-sm-6 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <select id="monthSelect" name="month" class="form-control" onchange="this.form.submit()">
                                                        ...
                                                        $monthQuery = "SELECT DISTINCT MONTH(start) AS month FROM tblactivity WHERE project = 'Cybersecurity'";
                                                        if (isset($_POST['project']) && $_POST['project'] != '') {
                                                            $sector = mysqli_real_escape_string($con, $_POST['project']);
                                                        ...
                                                        if (isset($_POST['mode']) && $_POST['mode'] != '') {
                                                            $mode = mysqli_real_escape_string($con, $_POST['mode']);
                                                            $monthQuery .= " AND mode = '$mode'";
                                                        }
                                                        if (isset($_POST['municipality']) && $_POST['municipality'] != '') {
                                                            $municipality = mysqli_real_escape_string($con, $_POST['municipality']);
                                                            $monthQuery .= " AND municipality = '$municipality'";
                                                        }
                                                        if (isset($_POST['barangay']) && $_POST['barangay'] != '') {
                                                            $barangay = mysqli_real_escape_string($con, $_POST['barangay']);
                                                            $monthQuery .= " AND barangay = '$barangay'";
                                                        }
                                        ...
                                        <table id="table" class="table table-bordered table-striped">
                                            ...
                                            if (isset($_POST['year']) && $_POST['year'] != '') {
                                              ...
                                              if (isset($_POST['month']) && $_POST['month'] != '') {
                                                  $tableQuery .= " AND MONTH(start) = '" . mysqli_real_escape_string($con, $_POST['month']) . "'";
                                              }
