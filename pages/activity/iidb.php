...
<body class="skin-black">
       ...
       <aside class="right-side">
            ...
            <section class="content-header">
                <div class="header-title">
                    <img src="img/logo/iidb 1.png" alt="Logo" class="header-logo" />
                    <div class="header-info">
                    <h3 style="color: #D5006D; font-weight: bold;">IIDB</h3>
    ...
    <form method="post" id="filterForm">
        <div class="row">
            ...
            <a href="../activity/activities_data_iidb.php"><div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number" id="totalParticipants">
                            <?php
                            $filterQuery = "SELECT COUNT(*) AS total_activities FROM tblactivity WHERE project = 'IIDB'";
            ...
            <!-- Total Municipality -->
            <div class="col-md-3 col-sm-6 col-xs-12">
            <a href="../activity/municipalities_data_iidb.php"><div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number">
                            <?php
                            $filterQuery = "SELECT COUNT(DISTINCT municipality) AS total_municipalities FROM tblactivity WHERE project = 'IIDB'";
                            if (isset($_POST['project']) && $_POST['project'] != '') {
                                $filterQuery .= " AND sector = '" . mysqli_real_escape_string($con, $_POST['project']) . "'";
                            }
                            if (isset($_POST['mode']) && $_POST['mode'] != '') {
            ...
            <!-- Total Barangay -->
            <div class="col-md-3 col-sm-6 col-xs-12">
            <a href="../activity/barangays_data_iidb.php"><div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number">
                            <?php
                            $filterQuery = "SELECT COUNT(DISTINCT barangay) AS total_barangays FROM tblactivity WHERE barangay IS NOT NULL AND barangay != '' AND project = 'IIDB'";
                            if (isset($_POST['project']) && $_POST['project'] != '') {
                                $filterQuery .= " AND sector = '" . mysqli_real_escape_string($con, $_POST['project']) . "'";
                            }
                            if (isset($_POST['mode']) && $_POST['mode'] != '') {
            ...
            <!-- Total Sectors -->
            <div class="col-md-3 col-sm-6 col-xs-12">
            <a href="../activity/sectors_data_iidb.php"><div class="info-box">
                    <span class="info-box-icon bg-blue">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number">
                            <?php
                            $filterQuery = "SELECT COUNT(DISTINCT sector) AS total_sectors FROM tblactivity WHERE sector IS NOT NULL AND sector != '' AND project = 'IIDB'";
                            if (isset($_POST['project']) && $_POST['project'] != '') {
                                $filterQuery .= " AND sector = '" . mysqli_real_escape_string($con, $_POST['project']) . "'";
                            }
                            if (isset($_POST['mode']) && $_POST['mode'] != '') {
        ...
        <div class="row">
        <div class="col-md-3 col-sm-6 col-xs-12">
        <a href="../planned_activities/planned_activities_iidb.php">
            <div class="info-box">
                <span class="info-box-icon bg-white">
                    <img src="img/logo/dict.png" alt="Total Activities" style="width: auto; height: 58px;">
                </span>
                <div class="info-box-content">
                    <span class="info-box-text" style="font-weight: bold;">Planned Activities - IIDB</span>
                    <p>
            ...
            <div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number">
                            <?php
                            $filterQuery = "SELECT SUM(completers) AS total_completers FROM tblactivity WHERE project = 'IIDB'";
                            if (isset($_POST['project']) && $_POST['project'] != '') {
                                $filterQuery .= " AND sector = '" . mysqli_real_escape_string($con, $_POST['project']) . "'";
                            }
                            if (isset($_POST['mode']) && $_POST['mode'] != '') {
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number">
                            <?php
                            $filterQuery = "SELECT SUM(male) AS total_male_completers FROM tblactivity WHERE project = 'IIDB'";
                            if (isset($_POST['project']) && $_POST['project'] != '') {
                                $filterQuery .= " AND sector = '" . mysqli_real_escape_string($con, $_POST['project']) . "'";
                            }
                            if (isset($_POST['mode']) && $_POST['mode'] != '') {
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number">
                            <?php
                            $filterQuery = "SELECT SUM(female) AS total_female_completers FROM tblactivity WHERE project = 'IIDB'";
                            if (isset($_POST['project']) && $_POST['project'] != '') {
                                $filterQuery .= " AND sector = '" . mysqli_real_escape_string($con, $_POST['project']) . "'";
                            }
                            if (isset($_POST['mode']) && $_POST['mode'] != '') {
    ...
    <div class="form-group">
        ...
        <select id="projectSelect" name="project" class="form-control" onchange="this.form.submit()">
            ...
            <?php
            $sectorQuery = "SELECT DISTINCT sector FROM tblactivity WHERE project = 'IIDB' AND sector IS NOT NULL AND sector != ''";
            if (isset($_POST['mode']) && $_POST['mode'] != '') {
...
<div class="col-md-3 col-sm-6 col-xs-12">
    <div class="form-group">
        ...
        <select id="modeSelect" name="mode" class="form-control" onchange="this.form.submit()">
            ...
            <?php
            $modeQuery = "SELECT DISTINCT mode FROM tblactivity WHERE project = 'IIDB' AND mode IS NOT NULL AND mode != ''";
            if (isset($_POST['project']) && $_POST['project'] != '') {
...
<div class="col-md-3 col-sm-6 col-xs-12">
    <div class="form-group">
        ...
        <select id="municipalitySelect" name="municipality" class="form-control" onchange="this.form.submit()">
            ...
            <?php
            $municipalityQuery = "SELECT DISTINCT municipality FROM tblactivity WHERE project = 'IIDB' AND municipality IS NOT NULL AND municipality != ''";
            if (isset($_POST['project']) && $_POST['project'] != '') {
                $sector = mysqli_real_escape_string($con, $_POST['project']);
...
<div class="col-md-3 col-sm-6 col-xs-12">
    <div class="form-group">
        ...
        <select id="barangaySelect" name="barangay" class="form-control" onchange="this.form.submit()">
            ...
            <?php
            $barangayQuery = "SELECT DISTINCT barangay FROM tblactivity WHERE project = 'IIDB' AND barangay IS NOT NULL AND barangay != ''";
            if (isset($_POST['project']) && $_POST['project'] != '') {
                $sector = mysqli_real_escape_string($con, $_POST['project']);
                                ...
                                <form method="post">
                                    <table id="table" class="table table-bordered table-striped">
                                        ...
                                        <?php
                                                  ...
                                                  $tableQuery = "SELECT * FROM tblactivity WHERE project = 'IIDB'";
...
document.getElementById('exportBtn').addEventListener('click', function() {
    ...
    var exportUrl = 'exportiidb.php?mode=' + encodeURIComponent(selectedMode) +
