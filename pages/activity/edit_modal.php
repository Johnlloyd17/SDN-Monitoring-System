            ...
            <div class="modal-content">
                ...
                <div class="modal-body modal-tabs">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="active"><a href="#act-edit-details" data-toggle="tab"><i class="fa fa-info-circle"></i> Activity Details</a></li>
                        <li><a href="#act-edit-location" data-toggle="tab"><i class="fa fa-map-marker"></i> Location &amp; Agency</a></li>
                        <li><a href="#act-edit-participants" data-toggle="tab"><i class="fa fa-users"></i> Participants &amp; MOVs</a></li>
                    </ul>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="act-edit-details">
                            <div class="row">
                                <div class="col-md-6">
                        ...
                        <div class="tab-pane" id="act-edit-location">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                        ...
                        <div class="tab-pane" id="act-edit-participants">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
