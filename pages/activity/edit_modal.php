                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <input name="txt_edit_start" class="form-control input-sm" type="text" value="' . htmlspecialchars($row['start'], ENT_QUOTES, 'UTF-8') . '" required />
                            </div>
                            <div class="form-group">
                                <label>End Date: </label>
                                <input name="txt_edit_end" class="form-control input-sm" type="text" value="' . htmlspecialchars($row['end'], ENT_QUOTES, 'UTF-8') . '" required/>
                            </div>
                            <div class="form-group">
                                <label>Bureau: </label>
                                <input name="txt_edit_project" class="form-control input-sm" type="text" value="' . htmlspecialchars($row['project'], ENT_QUOTES, 'UTF-8') . '" required/>
                            </div>
                            <div class="form-group">
                                <label>Project: </label>
