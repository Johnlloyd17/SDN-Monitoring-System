                                            ...
                                            <div class="col-md-3 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="municipalitySelect" name="municipality" class="form-control" onchange="this.form.submit()">
                                                            ...
                                                            $agenciesQuery = mysqli_query($con, "SELECT DISTINCT municipality FROM tblactivity WHERE municipality != '' AND project = 'ILCDB' ORDER BY municipality ASC");
                                                ...
                                                <div class="col-md-3 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="yearSelect" name="year" class="form-control" onchange="this.form.submit()">
                                                            ...
                                                            $yearQuery = "SELECT DISTINCT YEAR(start) AS year FROM tblactivity WHERE start != '' and municipality != '' AND project = 'ILCDB' AND start != ''";
                                                ...
                                                <div class="col-md-3 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="monthSelect" name="month" class="form-control" onchange="this.form.submit()">
                                                            ...
                                                            $monthQuery = "SELECT DISTINCT MONTH(start) AS month FROM tblactivity WHERE municipality != '' AND project = 'ILCDB'";
                                                            if (isset($_POST['municipality']) && $_POST['municipality'] != '') {
                                                                $municipality = mysqli_real_escape_string($con, $_POST['municipality']);
                                        ...
                                        <form method="post">
                                            <table id="table" class="table table-bordered table-striped">
                                                ...
                                                <?php
                                                 ...
                                                 $tableQuery = "SELECT * FROM tblactivity WHERE municipality != '' and project = 'ILCDB'";
