        ...
        <aside class="right-side">
            <section class="content-header">
                <div class="header-title">
                    <img src="img/icons/barangay.png" alt="Logo" class="header-logo" />
                    <div class="header-info">
                        <h3 style="color: darkwhite; font-weight: bold;">Total Barangays</h3>
                        <p class="header-address">Total Counts of Barangays (Distinct)</p>
                    </div>
                                            ...
                                            <div class="col-md-3 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="barangaySelect" name="barangay" class="form-control" onchange="this.form.submit()">
                                                            ...
                                                            $barangayQuery = "SELECT DISTINCT barangay FROM tblactivity WHERE barangay != '' AND project = 'Cybersecurity'";
                                                ...
                                                <div class="col-md-3 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="yearSelect" name="year" class="form-control" onchange="this.form.submit()">
                                                            ...
                                                            <?php
                                                            // Fetch distinct years based on selected filters
                                                            $yearQuery = "SELECT DISTINCT YEAR(start) AS year FROM tblactivity WHERE barangay != '' AND project = 'Cybersecurity' AND start != ''";
                                                ...
                                                <div class="col-md-3 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="monthSelect" name="month" class=" form-control" onchange="this.form.submit()">
                                                            ...
                                                            <?php
                                                            // Fetch distinct months based on selected filters
                                                            $monthQuery = "SELECT DISTINCT MONTH(start) AS month FROM tblactivity WHERE barangay != '' AND project = 'Cybersecurity'";
                                                            if (isset($_POST['barangay']) && $_POST['barangay'] != '') {
                                                                $barangay = mysqli_real_escape_string($con, $_POST['barangay']);
                                    ...
                                    <form method="post">
                                        <table id="table" class="table table-bordered table-striped">
                                            ...
                                            <?php
                                             ...
                                             $tableQuery = "SELECT * FROM tblactivity WHERE barangay != '' and project = 'Cybersecurity'";
