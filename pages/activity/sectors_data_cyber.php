                                                ...
                                                <div class="col-md-3 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="sectorSelect" name="sector" class="form-control" onchange="this.form.submit()">
                                                            ...
                                                            $agenciesQuery = mysqli_query($con, "SELECT DISTINCT sector FROM tblactivity WHERE sector != '' and project = 'Cybersecurity'");
                                                ...
                                                <div class="col-md-3 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="yearSelect" name="year" class="form-control" onchange="this.form.submit()">
                                                            ...
                                                            $yearQuery = "SELECT DISTINCT YEAR(start) AS year FROM tblactivity WHERE sector != '' AND project = 'Cybersecurity'";
                                                ...
                                                <div class="col-md-3 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="monthSelect" name="month" class="form-control" onchange="this.form.submit()">
                                                            ...
                                                            $monthQuery = "SELECT DISTINCT MONTH(start) AS month FROM tblactivity WHERE sector != '' AND project = 'Cybersecurity'";
                                                            if (isset($_POST['sector']) && $_POST['sector'] != '') {
                                                                $sector = mysqli_real_escape_string($con, $_POST['sector']);
                                    ...
                                    <form method="post">
                                        <table id="table" class="table table-bordered table-striped">
                                            ...
                                            <?php
                                             ...
                                             $tableQuery = "SELECT * FROM tblactivity WHERE sector != '' and project = 'Cybersecurity'";
