        ...
        <aside class="right-side">
            <section class="content-header">
                <div class="header-title">
                    <img src="img/cyber/act.png" alt="Logo" class="header-logo" />
                                            ...
                                            <div class="col-md-3 col-sm-6 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <select id="yearSelect" name="year" class="form-control" onchange="this.form.submit()">
                                                        ...
                                                        $yearQuery = "SELECT DISTINCT YEAR(start) AS year FROM tblactivity WHERE project = 'GECS'";
                                                        if (isset($_POST['project']) && $_POST['project'] != '') {
                                                            $sector = mysqli_real_escape_string($con, $_POST['project']);
                                            ...
                                            <div class="col-md-3 col-sm-6 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <select id="monthSelect" name="month" class="form-control" onchange="this.form.submit()">
                                                        ...
                                                        $monthQuery = "SELECT DISTINCT MONTH(start) AS month FROM tblactivity WHERE project = 'GECS'";
                                                        if (isset($_POST['project']) && $_POST['project'] != '') {
                                                            $sector = mysqli_real_escape_string($con, $_POST['project']);
