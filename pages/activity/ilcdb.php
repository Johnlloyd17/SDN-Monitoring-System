...
<body class="skin-black">
    ...
    <form method="post" id="filterForm">
        <div class="row">
            ...
            <a href="../activity/activities_data_cyber.php"><div class="info-box">
            ...
            <!-- Total Municipality -->
            <div class="col-md-3 col-sm-6 col-xs-12">
            <a href="../activity/municipalities_data_cyber.php"><div class="info-box">
            ...
            <!-- Total Barangay -->
            <div class="col-md-3 col-sm-6 col-xs-12">
            <a href="../activity/barangays_data_cyber.php"><div class="info-box">
