...
<body class="skin-black">
       ...
       <aside class="right-side">
            ...
            <section class="content-header">
                <div class="header-title">
                    <img src="img/logo/ILCDB.png" alt="Logo" class="header-logo" />
    ...
    <form method="post" id="filterForm">
        <div class="row">
            ...
            <a href="../activity/activities_data_ilcdb.php"><div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number" id="totalParticipants">
                            <?php
                            $filterQuery = "SELECT COUNT(*) AS total_activities FROM tblactivity WHERE project = 'ILCDB'";
                            if (isset($_POST['project']) && $_POST['project'] != '') {
                                $filterQuery .= " AND subproject = '" . mysqli_real_escape_string($con, $_POST['project']) . "'";
                            }
            ...
            <!-- Total Municipality -->
            <div class="col-md-3 col-sm-6 col-xs-12">
            <a href="../activity/municipalities_data_ilcdb.php"><div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number">
                            <?php
                            $filterQuery = "SELECT COUNT(DISTINCT municipality) AS total_municipalities FROM tblactivity WHERE project = 'ILCDB'";
                            if (isset($_POST['project']) && $_POST['project'] != '') {
                                $filterQuery .= " AND subproject = '" . mysqli_real_escape_string($con, $_POST['project']) . "'";
                            }
                            if (isset($_POST['indicator']) && $_POST['indicator'] != '') {
            ...
            <!-- Total Barangay -->
            <div class="col-md-3 col-sm-6 col-xs-12">
            <a href="../activity/barangays_data_ilcdb.php"><div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number">
                            <?php
                            $filterQuery = "SELECT COUNT(DISTINCT barangay) AS total_barangays FROM tblactivity WHERE barangay IS NOT NULL AND barangay != '' AND project = 'ILCDB'";
                            if (isset($_POST['project']) && $_POST['project'] != '') {
                                $filterQuery .= " AND subproject = '" . mysqli_real_escape_string($con, $_POST['project']) . "'";
                            }
                            if (isset($_POST['indicator']) && $_POST['indicator'] != '') {
            ...
            <!-- Total Sectors -->
            <div class="col-md-3 col-sm-6 col-xs-12">
            <a href="../activity/subprojects_data_cyber.php"><div class="info-box">
                    <span class="info-box-icon bg-blue">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number">
                            <?php
                            $filterQuery = "SELECT COUNT(DISTINCT subproject) AS total_subprojects FROM tblactivity WHERE subproject IS NOT NULL AND subproject != '' AND project = 'ILCDB'";
                            if (isset($_POST['project']) && $_POST['project'] != '') {
                                $filterQuery .= " AND subproject = '" . mysqli_real_escape_string($con, $_POST['project']) . "'";
                            }
                            if (isset($_POST['indicator']) && $_POST['indicator'] != '') {
        ...
        <div class="row">
        <div class="col-md-3 col-sm-6 col-xs-12">
        <a href="../planned_activities/planned_activities_ilcdb.php">
            <div class="info-box">
                <span class="info-box-icon bg-white">
                    <img src="img/logo/dict.png" alt="Total Activities" style="width: auto; height: 58px;">
                </span>
                <div class="info-box-content">
                    <span class="info-box-text" style="font-weight: bold;">Planned Activities - ILCDB</span>
                    <p>
            ...
            <div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number">
                            <?php
                            $filterQuery = "SELECT SUM(completers) AS total_completers FROM tblactivity WHERE project = 'ILCDB'";
                            if (isset($_POST['project']) && $_POST['project'] != '') {
                                $filterQuery .= " AND subproject = '" . mysqli_real_escape_string($con, $_POST['project']) . "'";
                            }
                            if (isset($_POST['indicator']) && $_POST['indicator'] != '') {
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number">
                            <?php
                            $filterQuery = "SELECT SUM(male) AS total_male_completers FROM tblactivity WHERE project = 'ILCDB'";
                            if (isset($_POST['project']) && $_POST['project'] != '') {
                                $filterQuery .= " AND subproject = '" . mysqli_real_escape_string($con, $_POST['project']) . "'";
                            }
                            if (isset($_POST['indicator']) && $_POST['indicator'] != '') {
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number">
                            <?php
                            $filterQuery = "SELECT SUM(female) AS total_female_completers FROM tblactivity WHERE project = 'ILCDB'";
                            if (isset($_POST['project']) && $_POST['project'] != '') {
                                $filterQuery .= " AND subproject = '" . mysqli_real_escape_string($con, $_POST['project']) . "'";
                            }
                            if (isset($_POST['indicator']) && $_POST['indicator'] != '') {
    ...
    <div class="form-group">
        ...
        <select id="projectSelect" name="project" class="form-control" onchange="this.form.submit()">
            ...
            <?php
            $subprojectQuery = "SELECT DISTINCT subproject FROM tblactivity WHERE project = 'ILCDB' AND subproject IS NOT NULL AND subproject != ''";
            if (isset($_POST['indicator']) && $_POST['indicator'] != '') {
                $indicator = mysqli_real_escape_string($con, $_POST['indicator']);
                $subprojectQuery .= " AND indicator = '$indicator'";
            }
            if (isset($_POST['municipality']) && $_POST['municipality'] != '') {
                $municipality = mysqli_real_escape_string($con, $_POST['municipality']);
                $subprojectQuery .= " AND municipality = '$municipality'";
            }
            if (isset($_POST['barangay']) && $_POST['barangay'] != '') {
                $barangay = mysqli_real_escape_string($con, $_POST['barangay']);
                $subprojectQuery .= " AND barangay = '$barangay'";
            }
            $subprojectsQuery = mysqli_query($con, $subprojectQuery);
            if ($subprojectsQuery) {
                while ($subproject = mysqli_fetch_assoc($subprojectsQuery)) {
                    echo '<option value="' . htmlspecialchars($subproject['subproject']) . '"' . (isset($_POST['project']) && $_POST['project'] == $subproject['subproject'] ? ' selected' : '') . '>' . htmlspecialchars($subproject['subproject']) . '</option>';
                }
            } else {
                echo "Error fetching subprojects: " . mysqli_error($con);
            }
            ?>
        </select>
    </div>
...
<div class="col-md-3 col-sm-6 col-xs-12">
    <div class="form-group">
        ...
        <select id="indicatorSelect" name="indicator" class="form-control" onchange="this.form.submit()">
            ...
            <?php
            $indicatorQuery = "SELECT DISTINCT indicator FROM tblactivity WHERE project = 'ILCDB' AND indicator IS NOT NULL AND indicator != ''";
            if (isset($_POST['project']) && $_POST['project'] != '') {
                $subproject = mysqli_real_escape_string($con, $_POST['project']);
                $indicatorQuery .= " AND subproject = '$subproject'";
            }
            if (isset($_POST['municipality']) && $_POST['municipality'] != '') {
                $municipality = mysqli_real_escape_string($con, $_POST['municipality']);
                $indicatorQuery .= " AND municipality = '$municipality'";
            }
            if (isset($_POST['barangay']) && $_POST['barangay'] != '') {
                $barangay = mysqli_real_escape_string($con, $_POST['barangay']);
                $indicatorQuery .= " AND barangay = '$barangay'";
            }
...
<div class="col-md-3 col-sm-6 col-xs-12">
    <div class="form-group">
        ...
        <select id="municipalitySelect" name="municipality" class="form-control" onchange="this.form.submit()">
            ...
            <?php
            $municipalityQuery = "SELECT DISTINCT municipality FROM tblactivity WHERE project = 'ILCDB' AND municipality IS NOT NULL AND municipality != ''";
            if (isset($_POST['project']) && $_POST['project'] != '') {
                $subproject = mysqli_real_escape_string($con, $_POST['project']);
                $municipalityQuery .= " AND subproject = '$subproject'";
            }
            if (isset($_POST['indicator']) && $_POST['indicator'] != '') {
                $indicator = mysqli_real_escape_string($con, $_POST['indicator']);
                $municipalityQuery .= " AND indicator = '$indicator'";
            }
            if (isset($_POST['barangay']) && $_POST['barangay'] != '') {
                $barangay = mysqli_real_escape_string($con, $_POST['barangay']);
...
<div class="col-md-3 col-sm-6 col-xs-12">
    <div class="form-group">
        ...
        <select id="barangaySelect" name="barangay" class="form-control" onchange="this.form.submit()">
            ...
            <?php
            $barangayQuery = "SELECT DISTINCT barangay FROM tblactivity WHERE project = 'ILCDB' AND barangay IS NOT NULL AND barangay != ''";
            if (isset($_POST['project']) && $_POST['project'] != '') {
                $subproject = mysqli_real_escape_string($con, $_POST['project']);
                $barangayQuery .= " AND subproject = '$subproject'";
            }
            if (isset($_POST['indicator']) && $_POST['indicator'] != '') {
                $indicator = mysqli_real_escape_string($con, $_POST['indicator']);
                $barangayQuery .= " AND indicator = '$indicator'";
            }
            if (isset($_POST['municipality']) && $_POST['municipality'] != '') {
                $municipality = mysqli_real_escape_string($con, $_POST['municipality']);
                            ...
                            <form method="post">
                                <table id="table" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        $tableQuery = "SELECT * FROM tblactivity WHERE project = 'ILCDB'";
                                        
                                        if (isset($_POST['project']) && $_POST['project'] != '') {
                                            $tableQuery .= " AND subproject = '" . mysqli_real_escape_string($con, $_POST['project']) . "'";
                                        }
...
document.getElementById('exportBtn').addEventListener('click', function() {
    ...
    var exportUrl = 'export_ilcdb.php?indicator=' + encodeURIComponent(selectedIndicator) +
                    '&subproject=' + encodeURIComponent(selectedSector) +
...
<style>
    .info-box-icon {
        ...
        table th {
            ...
            overflow-wrap: break-word; /* Ensure long words break in indicatorrn browsers */
