        ...
        <aside class="right-side">
            <section class="content-header">
                <div class="header-title">
                    <img src="icons/participants_2.png" alt="Logo" class="header-logo" />
                    <div class="header-info">
                        <h3 style="color: darkwhite; font-weight: bold;">Total Participants</h3>
                        <p class="header-address">Count of All Participants Who Attended</p>
                    </div>
                                                ...
                                                <div class="col-md-3 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="indicatorSelect" name="indicator" class="form-control" onchange="this.form.submit()">
                                                            ...
                                                            <?php
                                                            $indicatorQuery = "SELECT DISTINCT indicator FROM tblparticipant WHERE project = 'Cybersecurity'";
                                                            if (isset($_POST['project']) && $_POST['project'] != '') {
                                                                $project = mysqli_real_escape_string($con, $_POST['project']);
