        ...
        <aside class="right-side">
            <section class="content-header">
                <div class="header-title">
                    <img src="icons/male_2.png" alt="Logo" class="header-logo" />
                    <div class="header-info">
                        <h3 style="color: darkwhite; font-weight: bold;">Total Male</h3>
                        <p class="header-address">Count of Male Participants Who Attended</p>
                    </div>
                                        ...
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="projectSelect" name="project" class="form-control" onchange="this.form.submit()">
                                                            ...
                                                            <?php
                                                            $sectorQuery = "SELECT DISTINCT sector FROM tblparticipant WHERE project = 'Cybersecurity' and sex = 'Male'";
                                                ...
                                                <div class="col-md-3 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="modeSelect" name="mode" class="form-control" onchange="this.form.submit()">
                                                            ...
                                                            <?php
                                                            $modeQuery = "SELECT DISTINCT mode FROM tblparticipant WHERE project = 'Cybersecurity' and sex = 'Male'";
                                                ...
                                                <div class="col-md-3 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="indicatorSelect" name="indicator" class="form-control" onchange="this.form.submit()">
                                                            ...
                                                            <?php
                                                            $indicatorQuery = "SELECT DISTINCT indicator FROM tblparticipant WHERE project = 'Cybersecurity' and sex = 'Male'";
                                                            if (isset($_POST['project']) && $_POST['project'] != '') {
                                                                $project = mysqli_real_escape_string($con, $_POST['project']);
                                    ...
                                    <form method="post">
                                        <table id="table" class="table table-bordered table-striped">
                                            ...
                                            <?php
                                                        ...
                                                        $tableQuery = "SELECT * FROM tblparticipant WHERE project = 'Cybersecurity' and sex = 'Male'";
