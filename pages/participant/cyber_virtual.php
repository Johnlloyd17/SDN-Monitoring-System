...
<body class="skin-black">
        ...
        <aside class="right-side">
            <section class="content-header">
                <div class="header-title">
                    <img src="icons/virtual_2.png" alt="Logo" class="header-logo" />
                    <div class="header-info">
                        <h3 style="color: darkwhite; font-weight: bold;">Total Virtual</h3>
                        <p class="header-address">Count of Participants Who Attended Virtual</p>
                    </div>
                                        ...
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="projectSelect" name="project" class="form-control" onchange="this.form.submit()">
                                                            ...
                                                            <?php
                                                            $sectorQuery = "SELECT DISTINCT sector FROM tblparticipant WHERE project = 'Cybersecurity' and mode = 'Virtual'";
                                                ...
                                                <div class="col-md-3 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="indicatorSelect" name="indicator" class="form-control" onchange="this.form.submit()">
                                                            ...
                                                            <?php
                                                            $indicatorQuery = "SELECT DISTINCT indicator FROM tblparticipant WHERE project = 'Cybersecurity' and mode = 'Virtual'";
    ...
    <div class="form-group">
        ...
        <select id="sexSelect" name="sex" class="form-control" onchange="this.form.submit()">
            ...
            <?php 
            $sexQuery = "SELECT DISTINCT sex FROM tblparticipant WHERE project = 'Cybersecurity' and mode = 'Virtual' AND sex IS NOT NULL AND TRIM(sex) != ''";
                                    ...
                                    <form method="post">
                                        <table id="table" class="table table-bordered table-striped">
                                            ...
                                            <?php
                                                        ...
                                                        $tableQuery = "SELECT * FROM tblparticipant WHERE project = 'Cybersecurity' and mode = 'Virtual'";
