        ...
        <aside class="right-side">
            <section class="content-header">
                <div class="header-title">
                    <img src="icons/requests_2.png" alt="Logo" class="header-logo" />
                    <div class="header-info">
                        <h3 style="color: darkblue; font-weight: bold;">FreeWifi4All</h3>
                        <p class="header-address">Total Requests</p>
                    </div>
                                            ...
                                            <div class="col-md-3 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="localitySelect" name="locality" class="form-control" onchange="this.form.submit()">
                                                            ...
                                                            $localitiesQuery = mysqli_query($con, "SELECT DISTINCT locality FROM locationrequests WHERE locality != '' and type = 'Request'");
                                                ...
                                                <div class="col-md-3 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="yearSelect" name="year" class="form-control" onchange="this.form.submit()">
                                                            ...
                                                            $yearQuery = "SELECT DISTINCT year FROM locationrequests WHERE type = 'Request'";
                                        ...
                                        <form method="post">
                                            <table id="table" class="table table-bordered table-striped">
                                                ...
                                                <?php
                                                    ...
                                                    $tableQuery = "SELECT * FROM locationrequests WHERE type = 'Request'";
