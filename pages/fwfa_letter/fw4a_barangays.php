            ...
            <section class="content-header">
                <div class="header-title">
                    ...
                    <div class="header-info">
                        ...
                        <p class="header-address">Total Barangays</p>
                    </div>
                                            ...
                                            <div class="col-md-3 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="barangaySelect" name="barangay" class="form-control" onchange="this.form.submit()">
                                                            ...
                                                            $localitiesQuery = mysqli_query($con, "SELECT DISTINCT barangay FROM locationrequests WHERE barangay != ''");
                                                            while ($barangay = mysqli_fetch_assoc($localitiesQuery)) {
                                                ...
                                                <div class="col-md-3 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="yearSelect" name="year" class="form-control" onchange="this.form.submit()">
                                                            ...
                                                            $yearQuery = "SELECT DISTINCT year FROM locationrequests WHERE barangay != ''";
                                        ...
                                        <form method="post">
                                            <table id="table" class="table table-bordered table-striped">
                                                ...
                                                <?php
                                                    ...
                                                    $tableQuery = "SELECT * FROM locationrequests WHERE barangay != ''";
                                                    ...
                                                    $tableQuery .= " ORDER BY barangay ASC";
