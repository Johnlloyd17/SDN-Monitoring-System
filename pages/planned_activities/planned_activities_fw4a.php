...
<body class="skin-black">
    ...
    <div class="form-group">
        ...
        <select id="indicatorSelect" name="indicator" class="form-control" onchange="this.form.submit()">
            ...
            <?php
            $indicatorQuery = "SELECT DISTINCT indicator FROM targets_initiatives WHERE project = 'FWFA' and indicator IS NOT NULL AND indicator != ''";
            if (!empty($_POST['year'])) {
...
<div class="col-md-3 col-sm-6 col-xs-12">
    <div class="form-group">
        ...
        <select id="yearSelect" name="year" class="form-control" onchange="this.form.submit()">
            ...
            <?php
            $yearQuery = "SELECT DISTINCT YEAR(start) AS year FROM targets_initiatives WHERE project = 'FWFA' and start IS NOT NULL AND start != ''";
