...
<body class="skin-black">
            ...
            <section class="content-header">
                <div class="header-title">
                    ...
                    <div class="header-info">
                        <h3>Planned Activities - eLGU BPLS</h3>
    ...
    <div class="form-group">
        ...
        <select id="indicatorSelect" name="indicator" class="form-control" onchange="this.form.submit()">
            ...
            <?php
            $indicatorQuery = "SELECT DISTINCT indicator FROM targets_initiatives WHERE project = 'eLGU BPLS' and indicator IS NOT NULL AND indicator != ''";
            if (!empty($_POST['year'])) {
...
<div class="col-md-3 col-sm-6 col-xs-12">
    <div class="form-group">
        ...
        <select id="yearSelect" name="year" class="form-control" onchange="this.form.submit()">
            ...
            <?php
            $yearQuery = "SELECT DISTINCT YEAR(start) AS year FROM targets_initiatives WHERE project = 'eLGU BPLS' and start IS NOT NULL AND start != ''";
                                ...
                                <table id="table" class="table table-bordered table-striped">
                                    <thead>
                                        ...
                                        <?php
                                                      ...
                                                      $tableQuery = "SELECT * FROM targets_initiatives WHERE project = 'eLGU BPLS'";
