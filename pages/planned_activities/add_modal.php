            ...
            <div class="modal-content">
                ...
                <div class="modal-body modal-tabs">
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="active"><a href="#plan-tab-details" data-toggle="tab"><i class="fa fa-info-circle"></i> Activity Details</a></li>
                        <li><a href="#plan-tab-location" data-toggle="tab"><i class="fa fa-map-marker"></i> Location &amp; Agency</a></li>
                        <li><a href="#plan-tab-participants" data-toggle="tab"><i class="fa fa-users"></i> Participants &amp; MOVs</a></li>
                    </ul>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="plan-tab-details">
                            <div class="row">
                                <div class="col-md-6">
                        ...
                        <div class="tab-pane" id="plan-tab-location">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                        ...
                        <div class="tab-pane" id="plan-tab-participants">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
