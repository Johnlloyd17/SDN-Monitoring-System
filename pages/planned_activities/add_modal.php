                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <label>Bureau:</label>
                                <input name="txt_project" class="form-control input-sm" type="text" placeholder="Bureau"  />
                            </div>
                            <div class="form-group">
                                <label>Project:</label>
                            ...
                            <div class="form-group">
                                <label>Indicator:</label>
                                <textarea name="txt_indicator" class="form-control input-sm" placeholder="Indicator"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
