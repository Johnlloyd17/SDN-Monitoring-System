        ...
        <aside class="right-side">
            <section class="content-header">
                <div class="header-title">
                    <img src="icons/active_2.png" alt="Logo" class="header-logo" />
                    <div class="header-info">
                        <h3 style="color: darkblue; font-weight: bold;">FreeWifi4All</h3>
                        <p class="header-address">Active Access Points</p>
                    </div>
                                            ...
                                            <div class="col-md-3 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="localitySelect" name="locality" class="form-control" onchange="this.form.submit()">
                                                            ...
                                                            $localitiesQuery = mysqli_query($con, "SELECT DISTINCT locality FROM tblfwfa WHERE locality != '' and status = 'Active'");
                                                ...
                                                <div class="col-md-3 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="barangaySelect" name="barangay" class="form-control" onchange="this.form.submit()">
                                                            ...
                                                            $barangayQuery = "SELECT DISTINCT barangay FROM tblfwfa WHERE barangay != '' and status = 'Active'";
                                        ...
                                        <form method="post">
                                            <table id="table" class="table table-bordered table-striped">
                                                ...
                                                <?php
                                                    ...
                                                    $tableQuery = "SELECT * FROM tblfwfa WHERE locality != '' AND status = 'Active'";
