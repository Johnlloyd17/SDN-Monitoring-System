                    ...
                    <div class="row">
                        <div class="box">
                            <div class="box-header">
                                ...
                                <div class="col-md-3 col-sm-6 col-xs-12">
                                    <a href="../fw4a_data/fw4a_deactivated.php">
                                        <div class="info-box">
                                            <span class="info-box-icon bg-blue">
...
include "../footer.php"; ?>
    ...
    <style>
        ...
        table th {
            white-space: normal;
            text-align: center;
            /* Center-align headers if needed */
            word-wrap: break-word;
            /* Allow long words to break */
            overflow-wrap: break-word;
            /* Ensure long words break in modern browsers */
            max-width: 200px;
            /* Example max-width to limit header width */
        }

        table td {
            white-space: nowrap;
            /* Ensure cell text does not wrap */
        }
        ...
        /* Example width for checkbox column */
        table th:nth-child(2) {
            width: 50px;
        }

        /* Example width for No. column */
