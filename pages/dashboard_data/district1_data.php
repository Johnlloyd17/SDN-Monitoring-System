        ...
        <aside class="right-side">
            ...
            <section class="content-header">
                <div class="header-title">
                    <img src="icons/district_1.png" alt="Logo" class="header-logo" />
                    <div class="header-info">
                        <h3>District 1</h3>
                        <p class="header-address">Overview of Activities in District 1</p>
                    </div>
                                                ...
                                                <div class="col-md-3 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="municipalitySelect" name="municipality" class="form-control" onchange="this.form.submit()">
                                                            ...
                                                            $municipalitiesQuery = mysqli_query($con, "SELECT DISTINCT municipality FROM tblactivity WHERE (district = 'District 1' OR district = 'District 1 (Siargao)') AND municipality != '' AND municipality IS NOT NULL ORDER BY municipality ASC");
                                                            while ($municipality = mysqli_fetch_assoc($municipalitiesQuery)) {
                                                                $municipalityName = $municipality['municipality'];
                                                                echo '<option value="' . $municipalityName . '"' . (isset($_POST['municipality']) && $_POST['municipality'] == $municipalityName ? ' selected' : '') . '>' . $municipalityName . '</option>';
                                                            }
                                                            ?>
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="col-md-3 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="projectSelect" name="project" class="form-control" onchange="this.form.submit()">
                                                            ...
                                                            <?php
                                                            // Fetching distinct projects based on municipality filter
                                                            $projectFilter = isset($_POST['municipality']) ? $_POST['municipality'] : '';
                                                            $projectsQuery = "SELECT DISTINCT project FROM tblactivity WHERE (district = 'District 1' OR district = 'District 1 (Siargao)') ";
                                                            if ($projectFilter) {
                                                                $projectsQuery .= " AND municipality = '" . mysqli_real_escape_string($con, $projectFilter) . "'";
                                                            }
                                                            $projectsQuery .= " AND project != '' AND project IS NOT NULL";
                                                            $projectsResult = mysqli_query($con, $projectsQuery);
                                                            while ($project = mysqli_fetch_assoc($projectsResult)) {
                                                                $projectName = $project['project'];
                                                                echo '<option value="' . $projectName . '"' . (isset($_POST['project']) && $_POST['project'] == $projectName ? ' selected' : '') . '>' . $projectName . '</option>';
                                                            }
                                                            ?>
                                                       </select>
                                                    </div>
                                ...
                                <div class="box-body table-responsive">
                                    <form method="post">
                                        <table id="table" class="table table-bordered table-striped">
                                            ...
                                            $tableQuery = "SELECT * FROM tblactivity WHERE (district = 'District 1' OR district = 'District 1 (Siargao)')";
                                            ...
                                            if ($projectFilter) {
                                                $tableQuery .= " AND project = '" . mysqli_real_escape_string($con, $projectFilter) . "'";
                                            }
