        ...
        <aside class="right-side">
            ...
            <section class="content-header">
                <div class="header-title">
                    <img src="icons/district_2.png" alt="Logo" class="header-logo" />
                                                ...
                                                <div class="col-md-3 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="municipalitySelect" name="municipality" class="form-control" onchange="this.form.submit()">
                                                            ...
                                                            <?php
// Fetching distinct municipalities, ensuring non-empty values and sorting in ascending order
$municipalitiesQuery = mysqli_query($con, "SELECT DISTINCT municipality FROM tblactivity WHERE (district = 'District 2' OR district = 'District 2 (Mainland)') AND municipality != '' AND municipality IS NOT NULL ORDER BY municipality ASC"); 
                                                ...
                                                <div class="col-md-3 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="projectSelect" name="project" class="form-control" onchange="this.form.submit()">
                                                            ...
                                                            <?php
                                                            // Fetching distinct projects, ensuring non-empty values
                                                            $projectsQuery = mysqli_query($con, "SELECT DISTINCT project FROM tblactivity WHERE (district = 'District 2' OR district = 'District 2 (Mainland)') AND project != '' AND project IS NOT NULL");
                                ...
                                <div class="box-body table-responsive">
                                    <form method="post">
                                        <table id="table" class="table table-bordered table-striped">
                                            ...
                                            $tableQuery = "SELECT * FROM tblactivity WHERE (district = 'District 2' OR district = 'District 2 (Mainland)')";
