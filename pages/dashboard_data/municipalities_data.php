        ...
        <aside class="right-side">
            ...
            <section class="content-header">
                <div class="header-title">
                    <img src="icons/total_municipalities.png" alt="Logo" class="header-logo" />
                                            ...
                                            <div class="col-md-3 col-sm-6 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <select id="municipalitySelect" name="municipality" class="form-control" onchange="this.form.submit()">
                                                        ...
                                                        <?php
                                                        // Fetching distinct municipalities in ascending order
                                                        $agenciesQuery = mysqli_query($con, "SELECT DISTINCT municipality FROM tblactivity WHERE municipality != '' ORDER BY municipality ASC"); 
                                                ...
                                                <div class="col-md-3 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="barangaySelect" name="barangay" class="form-control" onchange="this.form.submit()">
                                                            ...
                                                            $barangayQuery = "SELECT DISTINCT barangay FROM tblactivity WHERE barangay != ''";
                                    ...
                                    <div class="box-body table-responsive">
                                        <table id="table" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                $tableQuery = "SELECT * FROM tblactivity WHERE municipality != ''";
