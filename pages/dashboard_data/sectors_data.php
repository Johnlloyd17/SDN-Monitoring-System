        ...
        <aside class="right-side">
            ...
            <section class="content-header">
                <div class="header-title">
                    <img src="icons/total_sectors.png" alt="Logo" class="header-logo" />
                    <div class="header-info">
                        <h3>Total Sectors</h3>
                        <p class="header-address">Overview of Distinct Sectors</p>
                    </div>
                                                ...
                                                <div class="col-md-3 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="sectorSelect" name="sector" class="form-control" onchange="this.form.submit()">
                                                            ...
                                                            <?php
                                                            // Fetching distinct sectors
                                                            $sectorsQuery = mysqli_query($con, "SELECT DISTINCT sector FROM tblactivity WHERE sector != ''");
                                    ...
                                    <div class="box-body table-responsive">
                                        <form method="post">
                                            <table id="table" class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                <?php
                                              $sectorFilter = isset($_POST['sector']) ? mysqli_real_escape_string($con, $_POST['sector']) : '';
                                              ...
                                              // Build the query
                                              $query = "SELECT * FROM tblactivity WHERE sector != ''";
                                              
                                              if ($sectorFilter) {
                                                  $query .= " AND sector = '$sectorFilter'";
                                              }
                                              if ($yearFilter) {
