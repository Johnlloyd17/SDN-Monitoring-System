        ...
        <aside class="right-side">
            <section class="content-header">
                <div class="header-title">
                    <img src="icons/nonoperational_2.png" alt="Logo" class="header-logo" />
                    <div class="header-info">
                        <h3 style="color: darkblue; font-weight: bold;">Tech4ED DTC</h3>
                        <p class="header-address">Total Non-Operational</p>
                    </div>
                                                ...
                                                <div class="col-md-3 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="municipalitySelect" name="municipality" class="form-control" onchange="this.form.submit()">
                                                            ...
                                                            $municipalitiesQuery = mysqli_query($con, "SELECT DISTINCT municipality FROM tbltech4ed WHERE municipality != '' AND operation= 'Non-Operational'");
                                                ...
                                                <div class="col-md-3 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="barangaySelect" name="barangay" class="form-control" onchange="this.form.submit()">
                                                            ...
                                                            $barangayQuery = "SELECT DISTINCT barangay FROM tbltech4ed WHERE barangay != '' AND operation= 'Non-Operational'";
                                                ...
                                                <div class="col-md-3 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="yearSelect" name="year" class="form-control" onchange="this.form.submit()">
                                                            ...
                                                            $yearQuery = "SELECT DISTINCT YEAR(launch) AS year FROM tbltech4ed WHERE operation= 'Non-Operational'";
                                                            if (isset($_POST['municipality']) && $_POST['municipality'] != '') {
                                                                $municipality = mysqli_real_escape_string($con, $_POST['municipality']);
                                        ...
                                        <form method="post">
                                            <table id="table" class="table table-bordered table-striped">
                                                ...
                                                <?php
                                                    ...
                                                    $tableQuery = "SELECT * FROM tbltech4ed WHERE operation= 'Non-Operational'";
